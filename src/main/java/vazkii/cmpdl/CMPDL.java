...
public final class CMPDL {
    ...
    static final Pattern FILE_NAME_URL_PATTERN = Pattern.compile(".*?/([^/]*)$");
    static boolean downloading = false;
    static Deque<String> missingMods = new LinkedList<>();
    ...
    public static void main(String[] args) {
        ...
        } else vazkii.cmpdl.UserInterface.openInterface();
    }
    ...
    public static void downloadFromURL(String url, String version) throws Exception {
        ...
        if (url.contains("feed-the-beast.com") && version.equals("latest")) {
            ...
            UserInterface.setStatus("Awaiting Further Input");
            return;
        }
        ...
        UserInterface.setStatus("Starting up");
        ...
        String fileUrl = packUrl + "/download/" + packVersion + "/file";
        ...
        if (matcher.matches()) {
            ...
            UserInterface.finishDownload(false);
    ...
    public static File downloadModpackMetadata(String filename, String url) throws IOException, ZipException {
        ...
        UserInterface.setStatus("Downloading Modpack .zip");
    ...
    public static void extractModpackMetadata(File f, File retDir) throws ZipException {
        ...
        UserInterface.setStatus("Unzipping Modpack Download");
        log("Unzipping file");
    ...
    public static Manifest getManifest(File dir) throws IOException {
        UserInterface.setStatus("Parsing Manifest");
    ...
    public static void copyOverrides(Manifest manifest, File tempDir, File outDir) throws IOException {
        UserInterface.setStatus("Copying modpack overrides");
    ...
    public static void setupMultimcInfo(Manifest manifest, File outputDir) throws IOException {
        ...
        UserInterface.setStatus("Setting up MultiMC info");
    ...
    public static void downloadFile(Manifest.FileData file, File modsDir, int remaining, int total) throws IOException, URISyntaxException {
        ...
        UserInterface.setStatus("File: " + file + " (" + (total - remaining) + "/" + total + ")");
        UserInterface.setStatus2("Acquiring Info");
        ...
        UserInterface.setStatus2("Downloading");
        ...
        if (filename.endsWith("cookieTest=1")) {
            ...
            try {
                ...
                UserInterface.addLogLine("Error: " + e.getClass().toString() + ": " + e.getLocalizedMessage());
                UserInterface.addLogLine("This mod will not be downloaded. If you need the file, you'll have to get it manually:");
                UserInterface.addLogLine(finalUrl);
